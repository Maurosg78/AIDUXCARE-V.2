  ...
  theme: {
    extend: {
      colors: {
        ...
        'aidux-dark': '#2C3E50',         // azul-pizarra
        'aidux-success': '#A8E6CF',      // verde-menta-suave
        'aidux-accent': '#FF6F61',       // coral-suave
        'aidux-neutral': '#BDC3C7',      // gris-neutro-claro
        'aidux-background': '#F7F7F7',   // blanco-hueso
        'aidux-primary': '#5DA5A3',      // verde-interseccion
        'aidux-secondary': '#6B7280',    // Para textos secundarios
        
        // Grises del Sistema (Mantenidos para funcionalidad)
        gray: {
          50: '#F9FAFB',
          100: '#F3F4F6', 
          200: '#E5E7EB',
        ...
        // Paleta de colores AiDuxCare V.2
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Colores específicos de AiDuxCare
        medical: {
          blue: '#5DA5A3',
          green: '#A8E6CF',
          coral: '#FF6F61',
    ...
    function({ addUtilities, theme }) {
      const medicalUtilities = {
        '.medical-card': {
          ...
          border: `1px solid ${theme('colors.medical.border')}`,
          padding: theme('spacing.6'),
        },
        '.medical-button': {
          backgroundColor: theme('colors.medical.blue'),
