...
type MedicalHistoryExtractionResponse = {
...
export const extractMajorMedicalHistory = async (
  transcript: string,
  ...
  const parsed = JSON.parse(jsonText) as MedicalHistoryExtractionResponse;
