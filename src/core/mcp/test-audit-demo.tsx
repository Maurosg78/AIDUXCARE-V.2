    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="mb-10 p-4 bg-gray-50 rounded border">
        ...
        <ul className="list-disc pl-5 mb-4">
          ...
          <li>
            Logs para visita <code>{testVisitId}</code>: {testVisitLogCount}
          </li>
          <li>
            Logs para visita <code>{otherVisitId}</code>: {otherVisitLogCount}
          </li>
        </ul>
      </div>
      ...
      <section className="mb-10">
        ...
        <div className="border p-4 rounded">
          <h3 className="text-lg mb-4">
            Vista de detalle para visita: {testVisitId}
          </h3>
          <AuditLogViewer visitId={testVisitId} logs={allLogs} />
        </div>
      </section>
