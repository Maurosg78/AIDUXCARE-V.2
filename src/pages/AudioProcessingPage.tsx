  ...
  const handleStartRecording = () => {
    ...
    setTimeout(() => {
      setTranscriptionText(
        "El paciente Andrea presenta dolor lumbar crónico...",
      );
    }, 2000);

    setTimeout(() => {
      setTranscriptionText(
        "El paciente Andrea presenta dolor lumbar crónico desde hace 3 meses. Refiere molestias al permanecer sentada por períodos prolongados...",
      );
    }, 4000);
    ...
    setTimeout(() => {
      ...
      setTranscriptionText(
        "El paciente Andrea presenta dolor lumbar crónico desde hace 3 meses. Refiere molestias al permanecer sentada por períodos prolongados. En la exploración física se observa tensión en paravertebrales L4-L5.",
      );
    }, 6000);
  };
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p style={{ color: "#BDC3C7" }}>
          Transcripción automática de consultas médicas con IA especializada en
          fisioterapia
        </p>
      </div>
      ...
      >
        ...
        <div
          className="min-h-32 p-4 rounded-md border"
        ...
        >
          {transcriptionText ? (
            ...
            <p className="italic" style={{ color: "#BDC3C7" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="text-sm space-y-1">
                <div>
                  <span className="font-medium" style={{ color: "#5DA5A3" }}>
                    S:
                  </span>{" "}
                  <span style={{ color: "#2C3E50" }}>
                ...
                <div>
                  <span className="font-medium" style={{ color: "#A8E6CF" }}>
                    O:
                  </span>{" "}
                  <span style={{ color: "#2C3E50" }}>
                    Tensión paravertebral L4-L5
                ...
                <div>
                  <span className="font-medium" style={{ color: "#FF6F61" }}>
                    A:
                  </span>{" "}
                  <span style={{ color: "#2C3E50" }}>Lumbalgia mecánica</span>
                </div>
                <div>
                  <span className="font-medium" style={{ color: "#5DA5A3" }}>
                    P:
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: "#2C3E50" }}>
              Esta es una demostración con datos pre-configurados. En el sistema
              real, la transcripción se realiza en tiempo real con tu micrófono.
            </p>
          </div>
        </div>
      </div>
