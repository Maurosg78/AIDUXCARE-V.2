  ...
  const runAdvancedAIDemo = useCallback(async () => {
    ...
    const mockAdvancedResult: AdvancedAudioProcessingResult = {
      ...
      agentSuggestions: [
        {
          ...
          type: 'recommendation',
          field: 'treatment',
          content: 'Considerar integración de neuromodulación transcutánea para optimizar control del dolor neuropático asociado',
        ...
        },
        {
          ...
          type: 'warning',
          field: 'treatment',
          content: 'Vigilar evolución de cefaleas - evaluar posible componente cervicogénico que requiera intervención específica',
      ...
      qualityAssessment: {
        ...
        red_flags: [],
        recommendations: ['Documentación de alta calidad', 'Enfoque terapéutico apropiado', 'Seguimiento clínico adecuado']
      },
      ...
      physiotherapyContext: {
        ...
        processed_transcript: {
          full_text: 'Transcripción completa de sesión avanzada con técnicas especializadas...',
          segments: [],
          entities: [],
          language: 'es',
        ...
        patterns: [
          {
            ...
            type: 'progression',
            pattern: 'Patrón de recuperación post-traumática con respuesta favorable a terapia manual especializada',
            confidence: 0.88,
            significance: 'high',
            evidence_support: {
          ...
          },
          {
            ...
            type: 'treatment',
            pattern: 'Enfoque multimodal óptimo: manual + ejercicio + educación para síndrome cervical',
            confidence: 0.92,
            significance: 'high',
            evidence_support: {
        ...
        alerts: [
          {
            ...
            description: 'Presencia de cefaleas asociadas a disfunción cervical requiere monitoreo específico',
            rationale: 'Las cefaleas cervicogénicas pueden requerir tratamiento dirigido específico para optimizar resultados',
            evidence_based: true,
            immediate_actions: [
        ...
        recommendations: [
          {
            ...
            description: 'Implementar programa de ergonomía específico para prevenir recurrencias post-trauma cervical',
            clinical_justification: 'La modificación ergonómica es crucial para prevenir recurrencias en síndrome cervical post-traumático',
            expected_outcomes: [
    ...
    const mockRAGResult: RAGQueryResult = {
      ...
      relevant_chunks: [],
      medical_context: 'Las técnicas de Mulligan han demostrado eficacia superior en el tratamiento del latigazo cervical comparado con terapia convencional, con mejoras significativas en dolor y función según systematic reviews de alta calidad.',
      confidence_score: 0.87,
      citations: [
        {
          document_id: 'pubmed_advanced_1',
          title: 'Efficacy of Mulligan techniques in whiplash-associated disorders: A systematic review and meta-analysis',
        ...
        },
        {
          ...
          title: 'Multimodal physiotherapy versus exercise therapy for chronic whiplash: Randomized controlled trial',
        ...
        },
        {
          ...
          title: 'Cervicogenic headache treatment protocols: Evidence-based clinical guidelines 2025',
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-sm text-blue-700">Entidades Clínicas</div>
                  </div>
            ...
            <div className="bg-white rounded-lg max-w-3xl w-full max-h-96 overflow-y-auto">
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-xl font-semibold text-gray-900">📚 Detalle Científico</h3>
                  <button 
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">{selectedArticle.journal} ({selectedArticle.year})</p>
                  </div>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Relevancia Clínica</h4>
