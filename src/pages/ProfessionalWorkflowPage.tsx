...
export const ProfessionalWorkflowPage: React.FC = () => {
  ...
  const handleStartListening = useCallback(() => {
    ...
    setTimeout(() => {
      setHighlights([
        ...
        {
          id: "4",
          text: "Ejercicios de fortalecimiento",
          category: "plan",
          confidence: 0.85,
          isSelected: false,
        },
  ...
  const generateSOAP = () => {
    ...
    const symptoms = selectedHighlights
      .filter((h) => h.category === "síntoma")
      .map((h) => h.text)
      .join(", ");
    const findings = selectedHighlights
      .filter((h) => h.category === "hallazgo")
      .map((h) => h.text)
      .join(", ");
    const plans = selectedHighlights
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#F7F7F7" }}>
      ...
      <div className="mx-4 mb-6">
        ...
        <div
          className="bg-white rounded-t-lg border-b-0 border p-4"
        ...
        <div
          className="bg-white rounded-b-lg border-t-0 border p-6"
          style={{ borderColor: "#BDC3C7" }}
        >
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              <h3
                ...
                style={{ color: "#5DA5A3", borderColor: "#BDC3C7" }}
              >
            ...
            <div className="space-y-4">
              <h3
                className="font-semibold text-sm uppercase tracking-wide pb-2 border-b"
                style={{ color: "#FF6F61", borderColor: "#BDC3C7" }}
              >
                Alertas Médicas
              </h3>
              <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mx-4 mb-6">
        ...
        >
          ...
          <p className="text-sm mb-4" style={{ color: "#7F8C8D" }}>
            Activa la transcripción automática del ambiente. El sistema
            identifica diferentes interlocutores y marca las partes del audio
          ...
          <div className="text-center">
            <button
              ...
              aria-label={
                isListening ? "Detener escucha" : "Iniciar escucha activa"
              }
            >
              {isListening ? (
                <svg
              ...
              >
                ...
                <span className="text-sm">
                  <span
                    ...
                    style={{
                      backgroundColor:
                        highlight.category === "síntoma"
                          ? "#FF6F61"
                          : highlight.category === "hallazgo"
                            ? "#A8E6CF"
                            : "#5DA5A3",
                      color:
                        highlight.category === "síntoma" ? "white" : "#2C3E50",
                    }}
                  >
                    {highlight.category}
                  </span>
        ...
        >
          ...
          <p className="text-sm mb-4" style={{ color: "#7F8C8D" }}>
            Alertas de seguridad, contraindicaciones y consideraciones
            iatrogénicas basadas en el perfil del paciente.
          </p>
          ...
          <div className="space-y-2 max-h-32 overflow-y-auto">
            {legalWarnings.map((warning) => (
              <div
                ...
                style={{
                  borderColor:
                    warning.severity === "alta" ? "#FF6F61" : "#BDC3C7",
                  backgroundColor:
                    warning.severity === "alta" ? "#FFF5F4" : "#F7F7F7",
                }}
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <span
                      ...
                      style={{
                        backgroundColor:
                          warning.severity === "alta" ? "#FF6F61" : "#5DA5A3",
                        color: "white",
                      }}
                    >
                      {warning.type}
                    </span>
                    <p className="text-xs mt-2" style={{ color: "#2C3E50" }}>
                      {warning.description}
                    </p>
                  </div>
                  <button
                    ...
                    style={{
                      backgroundColor: warning.isAccepted
                        ? "#5DA5A3"
                        : "#BDC3C7",
                    }}
                  >
      ...
      <div className="mx-4 mb-6">
        ...
        >
          ...
          <p className="text-sm mb-4" style={{ color: "#7F8C8D" }}>
            Documentación clínica estructurada, lógica y temporal. Lista para
            exportación PDF.
          </p>
            ...
            {soapContent ? (
              ...
              <div className="text-center text-gray-500 mt-16">
                ...
                <p style={{ color: "#7F8C8D" }}>
                  Las notas SOAP aparecerán aquí automáticamente
                </p>
                <p className="text-xs mt-1" style={{ color: "#BDC3C7" }}>
                  Selecciona elementos y genera la documentación
                </p>
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-lg p-6 m-4 max-w-md w-full shadow-xl">
            ...
            <div className="space-y-4">
              <div
                ...
                style={{ backgroundColor: "#A8E6CF" }}
              >
                <h4 className="font-medium mb-2" style={{ color: "#2C3E50" }}>
