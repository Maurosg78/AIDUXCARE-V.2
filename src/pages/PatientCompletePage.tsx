...
// === SERVICIOS CENTRALIZADOS PARA ELIMINAR MEMORY LEAKS ===
...
const PatientCompletePage: React.FC = () => {
  ...
  useInterval(
    ...
    workplace.session.status === 'ACTIVE' ? 1000 : null // Solo activo cuando sesión está activa
  );
  ...
  useInterval(
    ...
    workplace.session.status === 'ACTIVE' && workplace.activeListening.currentTranscript 
      ? 3000 
      : null
  );
