  ...
  useEffect(() => {
    const fetchPatientData = async () => {
      ...
      try {
        ...
        // Obtener visitas
        const visitsData =
          await visitDataSourceSupabase.getVisitsByPatientId(id);
          ...
          <div className="bg-white shadow-sm rounded-md p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="p-3 bg-gray-50 rounded-md">
                ...
                <p className="text-sm text-gray-600">
                  Medicación actual:{" "}
                  {patient.current_medication || "No registrada"}
                </p>
              </div>
            </div>
            ...
            {isCreatingVisit && (
              <div className="bg-blue-50 p-4 rounded-md mb-6 border border-blue-100">
                <h3 className="font-medium text-blue-800 mb-3">
                  Crear nueva visita para {patient.full_name}
                </h3>
            ...
            {sortedVisits.length === 0 ? (
              ...
              <div className="grid grid-cols-1 gap-4">
                {sortedVisits.map((visit, index) => (
                  <div
                    key={visit.id}
                    className="border rounded-md p-4 hover:border-blue-300 transition"
                  >
                    ...
                    <div className="mt-2 flex flex-col sm:flex-row sm:justify-between">
                      ...
                      <div className="text-xs text-gray-500 mt-1 sm:mt-0">
                        Creada:{" "}
                        {format(
                          new Date(visit.created_at || visit.date),
                          "dd/MM/yyyy HH:mm",
                        )}
                      </div>
                    </div>
