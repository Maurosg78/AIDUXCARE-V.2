 ...
 */
const SuggestionContextOrigin: React.FC<SuggestionContextOriginProps> = ({
  suggestion,
}) => {
    ...
    >
      ...
      <div className="flex flex-col">
        <span className="text-xs text-gray-600 mb-1">
          <span className="font-medium">Bloque fuente:</span>{" "}
          {suggestion.context_origin.source_block}
        </span>
