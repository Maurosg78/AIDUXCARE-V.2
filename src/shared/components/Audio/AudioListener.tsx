  ...
  return (
    <div className="bg-white rounded-md shadow-sm p-4 mb-6">
      ...
      <p className="text-sm text-gray-600 mb-4">
        Inicie la escucha activa para capturar y transcribir la conversación
        clínica. La transcripción debe ser revisada antes de incorporarla al
        EMR.
      </p>
      ...
      {isCapturing && (
        <div className="mt-4 p-3 bg-yellow-50 border border-yellow-100 rounded-md">
          <p className="text-sm text-yellow-800">
            <span className="font-medium">Importante:</span> La grabación en
            curso requiere el consentimiento informado del paciente. Solo se
            transcribirá el audio cuando se detenga la grabación y deberá
            revisarse antes de su incorporación al sistema.
          </p>
        </div>
      )}
    </div>
