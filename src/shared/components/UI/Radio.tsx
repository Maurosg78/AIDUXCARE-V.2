...
const variantStyles: Record<RadioVariant, string> = {
  default:
    "bg-white border-gray-300 checked:bg-primary-500 checked:border-primary-500",
  outline:
    "bg-transparent border-2 border-gray-300 checked:bg-primary-500 checked:border-primary-500",
  filled:
    "bg-gray-100 border-transparent checked:bg-primary-500 checked:border-primary-500",
};
...
export const Radio = React.forwardRef<HTMLInputElement, RadioProps>(
  (
    ...
    const baseStyles =
      "rounded-full border transition-colors duration-200 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2";
