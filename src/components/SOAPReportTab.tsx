    ...
    <div className="space-y-4 p-4">
      <Card className="p-4">
        ...
        <div className="space-y-4">
          {/* SUBJETIVO */}
          <div>
            <h3 className="font-semibold text-lg mb-2 text-blue-600">S - ""</h3>
            {isEditing ? (
              <textarea
          ...
          {/* OBJETIVO */}
          <div>
            <h3 className="font-semibold text-lg mb-2 text-green-600">O - ""</h3>
            {isEditing ? (
              <textarea
          ...
          {/* PLAN */}
          <div>
            <h3 className="font-semibold text-lg mb-2 text-orange-600">P - ""</h3>
            {isEditing ? (
              <textarea
