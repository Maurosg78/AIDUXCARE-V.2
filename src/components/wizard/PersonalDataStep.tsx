              ...
              <div className="flex">
                <div className="flex-shrink-0 w-12">
                  <button
                    ...
                    className="flex items-center justify-center space-x-0.5 px-1 py-2 w-full border border-gray-200 rounded-l-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
                  >
                    <span className="text-xs">{selectedCountryCode?.flag || '🌍'}</span>
