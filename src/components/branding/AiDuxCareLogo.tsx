    ...
    >
      ...
      <defs>
        ...
        >
          <stop
            offset="0%"
            style={{
              stopColor: "var(--aidux-intersection-green)",
              stopOpacity: 1,
            }}
          />
          <stop
            offset="100%"
            style={{
              stopColor: "var(--aidux-intersection-green-dark)",
              stopOpacity: 1,
            }}
          />
        </linearGradient>
      ...
      <g transform="translate(60,25)" opacity="0.6">
        <rect
          ...
          width="2"
          height="8"
          fill="var(--aidux-mint-green-dark)"
        />
        <rect
          x="-4"
          y="-1"
...
export const AiDuxCareLogoCompact: React.FC<{ className?: string }> = ({
  className = "",
}) => <AiDuxCareLogo size="sm" className={`${className}`} />;

// Componente para páginas principales
export const AiDuxCareLogoHero: React.FC<{ className?: string }> = ({
  className = "",
