...
describe("AgentExecutor", () => {
  beforeEach(() => {
    ...
    vi.mocked(ClinicalAgent.create).mockResolvedValue(
      mockAgent as unknown as ClinicalAgent,
    );
  ...
  it("debe devolver sugerencias con getSuggestions", async () => {
    ...
    vi.mocked(ClinicalAgent.create).mockResolvedValueOnce(
      mockAgentWithSuggestions as unknown as ClinicalAgent,
    );
  ...
  it("debe manejar correctamente un contexto vacío", async () => {
    ...
    vi.mocked(ClinicalAgent.create).mockResolvedValueOnce(
      mockAgentEmptyContext as unknown as ClinicalAgent,
    );
