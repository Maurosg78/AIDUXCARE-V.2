...
export const useEvent = <T extends (...args: unknown[]) => unknown>(fn: T): T => fn;
...
export const MenuButton = setDisplayName(
  forwardRef<HTMLButtonElement, MenuButtonProps>(({ children, className, onClick, disabled }, ref) => (
    <button
      ref={ref}
      className={className}
      onClick={onClick}
...
export const MenuItem = setDisplayName(
  forwardRef<HTMLButtonElement, MenuItemProps>(({ children, className, onClick }, ref) => (
    <button
      ref={ref}
      className={className}
      onClick={onClick}
...
export const ListboxButton = setDisplayName(
  forwardRef<HTMLButtonElement, ListboxButtonProps>(({ children, className, onClick }, ref) => (
    <button
      ref={ref}
      className={className}
      onClick={onClick}
...
export const ListboxOption = setDisplayName(
  forwardRef<HTMLButtonElement, ListboxOptionProps>(({ children, className, onClick }, ref) => (
    <button
      ref={ref}
      className={className}
      onClick={onClick}
...
Disclosure.Button = setDisplayName(
  forwardRef<HTMLButtonElement, DisclosureButtonProps>(({ children, ...props }, ref) => (
...
export const Switch = setDisplayName(
  forwardRef<HTMLButtonElement, Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'onChange'> & SwitchProps>(({ checked, onChange, children, ...props }, ref) => {
  return (
    <button
      ref={ref}
      type="button"
...
Combobox.Input = setDisplayName(
  forwardRef<HTMLInputElement, ComboboxInputProps>(({ ...props }, ref) => (
    <input ref={ref} {...props} type="text" className="w-full border rounded p-2" />
  )),
  'Combobox.Input'
);
...
RadioGroup.Option = setDisplayName(
  forwardRef<HTMLDivElement, RadioGroupOptionProps>(({ children, value, ...props }, ref) => (
...
Popover.Button = setDisplayName(
  forwardRef<HTMLButtonElement, PopoverButtonProps>(({ children, ...props }, ref) => (
    <button ref={ref} {...props} type="button">
      {children}
    </button>
  )),
