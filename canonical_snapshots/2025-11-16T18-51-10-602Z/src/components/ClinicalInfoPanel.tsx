      ...
      <div className="h-full w-full max-w-md bg-white shadow-xl flex flex-col">
        ...
        <footer className="border-t border-slate-200 px-5 py-4">
          <p className="text-xs text-slate-500">
            Esta información es orientativa, basada en evidencia general. No constituye una prescripción ni reemplaza el juicio clínico. Revise siempre las guías locales y la ficha técnica.
          </p>
        </footer>
      </div>
    </div>
