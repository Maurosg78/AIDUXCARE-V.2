...
const DEFAULT_TESTS = [
  {
    test: "Region-specific screening",
    sensibilidad: null,
    especificidad: null,
    objetivo: "Initial musculoskeletal assessment",
    contraindicado_si: "Acute fracture, suspected instability",
    justificacion: "Baseline recommendation when AI cannot determine a specific test.",
    evidencia: undefined
  }
];
