            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Manage your account and view transparency information.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-gray-200">
                <button
                  ...
                  className="flex items-center justify-between w-full px-4 py-3 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors text-left"
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Supply Chain Transparency</p>
