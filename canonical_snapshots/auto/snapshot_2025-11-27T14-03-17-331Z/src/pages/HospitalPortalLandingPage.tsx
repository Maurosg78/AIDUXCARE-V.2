    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F7F7F7] via-white to-[#F7F7F7] flex items-center justify-center p-4">
      <div className="max-w-5xl w-full">
        ...
        <div className="text-center mt-12">
          <div className="bg-white/60 backdrop-blur-sm rounded-lg shadow-sm p-6 max-w-3xl mx-auto border border-[#BDC3C7]/20">
            <p className="text-sm text-[#95A5A6] font-light">
              Secure • PHIPA Compliant • Canadian Data Sovereignty
            </p>
          </div>
        </div>
      </div>
