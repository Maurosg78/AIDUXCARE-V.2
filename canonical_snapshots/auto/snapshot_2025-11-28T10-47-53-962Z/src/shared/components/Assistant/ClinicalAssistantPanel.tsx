  ...
  return (
    <div className="space-y-3">
      <div className="flex gap-2">
        ...
        />
        <button onClick={onAsk} className="px-3 py-1 rounded bg-gradient-to-r from-primary-blue to-primary-purple text-white hover:from-primary-blue-hover hover:to-primary-purple-hover font-apple text-[15px] font-medium" disabled={loading}>
