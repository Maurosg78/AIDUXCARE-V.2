...
**Uso:** Copiar TODO este código en el editor inline de Firebase Console
...
En la sección de dependencias del editor inline, agrega:
...
1. **Para monthlyTokenReset:**
   - Copia TODO el código arriba
   - Pégalo en el editor inline
   - Configura como Cloud Scheduler con schedule `0 0 1 * *`

2. **Para manualTokenReset:**
   - Copia TODO el mismo código
   - Pégalo en el editor inline
   - Configura como HTTPS/Callable con autenticación requerida

**Nota:** Ambas funciones están en el mismo archivo, Firebase Console las detectará automáticamente cuando copies el código completo.
