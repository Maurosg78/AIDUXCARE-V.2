...
interface RealTimeAudioCaptureProps {
  ...
  physiotherapistId?: string; // ✅ PHIPA compliance: Required for verbal consent
  onConsentRequired?: () => void; // Callback when consent is required
}
...
const RealTimeAudioCapture: React.FC<RealTimeAudioCaptureProps> = ({
  ...
  physiotherapistId, // ✅ PHIPA compliance: Required for verbal consent
  onConsentRequired, // Callback when consent is required
}) => {
