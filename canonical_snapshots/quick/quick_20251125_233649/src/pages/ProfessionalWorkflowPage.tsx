      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="ml-auto text-xs font-semibold text-slate-600 font-apple">#1</span>
            </div>
            ...
            {activeEpisode.loading ? (
              <p className="text-xs text-slate-400 font-apple font-light">Loading plan...</p>
            ) : activeEpisode.data?.treatmentPlan?.goals && activeEpisode.data.treatmentPlan.goals.length > 0 ? (
              <div className="mt-2 pt-2 border-t border-slate-100">
                <p className="text-xs text-slate-600 font-apple font-light">
                  {activeEpisode.data.treatmentPlan.goals[0]?.description || 'Active treatment plan'}
                </p>
              </div>
            ) : null}
        </div>
