              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                ...
                <ul className="list-disc pl-6 text-blue-800 space-y-2">
                  <li>
                    ...
                    <br />
                    <span className="text-sm">Location: United States | Purpose: Audio transcription</span>
                  </li>
                  <li>
                    <strong>Clinical Analysis:</strong> Google Cloud Platform - Vertex AI (Gemini 2.5 Flash)
                    <br />
                    <span className="text-sm">Location: United States (us-central1 region) | Purpose: Clinical data analysis</span>
                  </li>
                  <li>
                    <strong>SOAP Note Generation:</strong> Google Cloud Platform - Vertex AI (Gemini 2.0 Flash)
                    <br />
                    <span className="text-sm">Location: United States (us-central1 region) | Purpose: SOAP note generation</span>
                  </li>
                </ul>
                <p className="text-blue-800 mt-3 text-sm">
                  <strong>Important:</strong> All AI processing occurs in the United States. Your health information will be subject to United States laws, including the CLOUD Act.
                </p>
              </div>
            </section>
