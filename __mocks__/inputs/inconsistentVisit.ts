...
export const inconsistentContextualMemory = [
  {
    ...
    content:
      "Paciente con dolor epigástrico y náuseas de 24 horas de evolución",
...
export const inconsistentSemanticMemory = [
  {
    ...
    type: "semantic",
    content:
      "El dolor epigástrico puede estar asociado a enfermedad ácido-péptica, pancreatitis o patología biliar",
