...
- Full auth/login flow requires real Firebase credentials in `.env.local`. With placeholder values, the app loads and renders fully but login attempts return a credential error.
