...
const outputPath = "docs/north/workorders/WO-2025-003-PHASE1-DOD.md";
const timestamp = new Date().toISOString().split("T")[0];

const report = `
# ✅ WO-2025-003 — Phase 1 (A–D) — Definition of Done
...
fs.mkdirSync("docs/north/workorders", { recursive: true });
fs.writeFileSync(outputPath, report.trim());
console.log(`✅ Phase 1 DoD report generated → ${outputPath}`);
