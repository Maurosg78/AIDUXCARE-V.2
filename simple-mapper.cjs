const fs = require('fs');
const content = `export function mapVertexToSpanish(vertexData: any): any {
...
fs.writeFileSync('src/utils/vertexFieldMapper.ts', content);
console.log('✅ Simple mapper installed');
